...
const Menu = () => {
	return (
		<div className="bgwhite grid h-max grid-cols-2 gap-2 overflow-hidden rounded-lg shadow-shadow-app">
			...
			<div className="flex flex-col justify-center gap-1 pb-4 pt-2">
				...
				<div className="flex gap-3">
					...
					<button className="box-content rounded-md bg-primary px-2.5 py-2 text-text-light shadow-shadow-menu">
						<TbTrashXFilled />
					</button>
				</div>
			</div>
